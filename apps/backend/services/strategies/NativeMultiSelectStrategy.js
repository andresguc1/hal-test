...
export class NativeMultiSelectStrategy extends BaseStrategy {
...
registerStrategy('select-multi', NativeMultiSelectStrategy);
export default NativeMultiSelectStrategy;
