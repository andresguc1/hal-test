...
if (!supabaseUrl || !supabaseAnonKey) {
    console.warn('⚠️ [AUTH] Supabase credentials missing (VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY).');
    console.warn('⚠️ [AUTH] Frontend authentication functionality will be disabled.');
}
