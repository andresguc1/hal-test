 ...
 */
export const ModelDiscoveryCombobox = forwardRef(function ModelDiscoveryCombobox(
  ...
  return (
    <div>
                ...
                <div className={`px-2 py-1 text-[10px] ${tone}`}>
                  ...
                  {state === "SUCCESS" && models.length > 0 && (
                    <span className="text-slate-500 ml-1">
                      • {t("settings.ai.model_discovery.found_n", { count: models.length })}
                    </span>
                  )}
                </div>
              )}
      ...
      {state !== "IDLE" && (
        <p className={`text-[10px] mt-1 leading-tight flex items-center gap-1 ${tone}`}>
