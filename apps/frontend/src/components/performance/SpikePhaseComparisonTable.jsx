  ...
  const phases = [
    {
      ...
      desc: t("performance.spike.pre_desc", "Stable baseline load before sudden spike"),
      stats: pre,
    ...
    },
    {
      ...
      desc: t("performance.spike.peak_desc", "Instantaneous overload of maximum concurrency"),
      stats: peak,
    ...
    },
    {
      ...
      desc: t("performance.spike.post_desc", "Cooldown and return to normal parameters"),
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-semibold text-slate-100 flex items-center gap-2">
            ...
            {t("performance.spike.matrix_title", "Comparative Matrix by Sudden Spike Phases")}
          </h3>
          <p className="text-xs text-slate-400 mt-0.5">
            {t("performance.spike.matrix_subtitle", "Tri-phasic comparison to evaluate the degree of impact and self-recovery capacity of the system.")}
          </p>
        </div>
          ...
          >
            ...
            <div className="space-y-2 pt-2 border-t border-slate-800/60 text-xs font-mono">
              <div className="flex justify-between items-center">
                <span className="text-slate-500">{t("performance.headers.p95_latency", "P95 Latency")}:</span>
                <span
                  className={`font-bold ${
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-500">{t("performance.headers.avg_latency", "Average Latency")}:</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-500">{t("performance.headers.throughput", "Throughput")}:</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-500">{t("performance.headers.error_rate", "Error Rate")}:</span>
                <span
                  className={`font-bold ${
