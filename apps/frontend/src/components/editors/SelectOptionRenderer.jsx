...
export const SelectOptionRenderer = React.memo(({ detectedOptions, config, onChange, t, multiSelect }) => {
        ...
        <div className="space-y-2">
            ...
            <div className="border border-slate-700/60 rounded-xl overflow-hidden max-h-48 overflow-y-auto custom-scrollbar divide-y divide-slate-800/60">
                {detectedOptions.map((opt, idx) => {
                    ...
                    const badge = TYPE_BADGE[opt.type] || TYPE_BADGE.select;
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Action selector - for select types, use SELECT/NO_CHANGE */}
...
SelectOptionRenderer.displayName = 'SelectOptionRenderer';
