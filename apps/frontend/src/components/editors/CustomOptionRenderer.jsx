...
const TYPE_BADGE = {
    custom_component: { label: 'Custom', cls: 'bg-orange-500/15 text-orange-400 border-orange-500/30' },
...
export const CustomOptionRenderer = React.memo(({ detectedOptions, config, onChange, t, multiSelect }) => {
