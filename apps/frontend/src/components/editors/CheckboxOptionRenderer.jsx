...
export const CheckboxOptionRenderer = React.memo(({ detectedOptions, config, onChange, t }) => {
        ...
        <div className="space-y-2">
            ...
            <div className="border border-slate-700/60 rounded-xl overflow-hidden max-h-48 overflow-y-auto custom-scrollbar divide-y divide-slate-800/60">
                {detectedOptions.map((opt, idx) => {
                    ...
                    const badge = TYPE_BADGE[opt.type] || TYPE_BADGE.checkbox;
                        ...
                        >
                            ...
                            <div className="shrink-0 flex items-center">
                                <div className="flex items-center gap-0.5">
                                    {[ACTION_NO_CHANGE, ACTION_CHECK, ACTION_UNCHECK].map((a) => {
...
CheckboxOptionRenderer.displayName = 'CheckboxOptionRenderer';
export default CheckboxOptionRenderer;