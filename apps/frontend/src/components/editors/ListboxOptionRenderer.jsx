...
const TYPE_BADGE = {
    listbox: { label: 'Listbox', cls: 'bg-emerald-500/15 text-emerald-400 border-emerald-500/30' },
    list: { label: 'List', cls: 'bg-emerald-500/15 text-emerald-400 border-emerald-500/30' },
    'aria_option': { label: 'Option', cls: 'bg-emerald-500/15 text-emerald-400 border-emerald-500/30' },
};
...
export const ListboxOptionRenderer = React.memo(({ detectedOptions, config, onChange, t, multiSelect }) => {
    ...
    const actionKey = multiSelect ? 'SELECT' : 'CHECK';
        ...
        <div className="space-y-2">
            ...
            <div className="flex items-center justify-between px-3 py-2 bg-slate-800/60 rounded-xl border border-slate-700/60">
                ...
                <div className="flex items-center gap-1">
                    {multiSelect && enabledCount > 0 && (
                        ...
                        >
                            <ListChecks size={10} className="inline mr-0.5" />
            ...
            <div className="border border-slate-700/60 rounded-xl overflow-hidden max-h-48 overflow-y-auto custom-scrollbar divide-y divide-slate-800/60">
                {detectedOptions.map((opt, idx) => {
                    ...
                    const badge = TYPE_BADGE[opt.type] || TYPE_BADGE.listbox;
                        ...
                        >
                            ...
                            <div className="shrink-0 flex items-center">
                                <div className="flex items-center gap-0.5">
                                    {[ACTION_NO_CHANGE, actionKey].map((a) => {
...
ListboxOptionRenderer.displayName = 'ListboxOptionRenderer';
export default ListboxOptionRenderer;