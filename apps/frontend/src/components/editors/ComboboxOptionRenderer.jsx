...
export const ComboboxOptionRenderer = React.memo(
  ({ detectedOptions, config, onChange, t }) => {
    ...
    const selectedOption = detectedOptions.find(
      (o) => getAction(o) === "SELECT",
    );
                ...
                <div className="shrink-0 flex items-center">
                  <div className="flex items-center gap-0.5">
                    {[ACTION_NO_CHANGE, "SELECT"].map((a) => {
                      ...
                      const disabled =
                        opt.enabled === false || disabledForSelect;
                      return (
                        <button
                          key={a}
                          type="button"
