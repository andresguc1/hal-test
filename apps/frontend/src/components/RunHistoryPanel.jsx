...
export default function RunHistoryPanel({
  ...
  return (
    <Motion.div
      ...
      className="relative h-full flex flex-col shrink-0 glass-panel z-[var(--z-hud)] border-l border-white/5 bg-[#0f172a]/95 backdrop-blur-xl"
    >
      {isMinimized ? (
